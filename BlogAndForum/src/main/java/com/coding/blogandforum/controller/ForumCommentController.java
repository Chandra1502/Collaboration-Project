...
import com.coding.blogandforum.DAO.ForumCommentDAO;
...
public class ForumCommentController {
	...
	public ResponseEntity<ForumComment> addForumComment(@PathVariable("forumid") int forumid, @RequestBody ForumComment forumComment)
	{
